...
L.SpecWarn_FlashFrameRepeat	= "Flasher %d fois"
L.SpecWarn_Flash			= "Flasher l'écran"
L.SpecWarn_Vibrate			= "Vibrations manette"
L.SpecWarn_FlashRepeat		= "Répéter flash" 
L.SpecWarn_FlashColor		= "Couleur flash"
L.SpecWarn_FlashDur			= "Durée du flash : %0.1f"
L.SpecWarn_FlashAlpha		= "Alpha du flash : %0.1f"
...
L.EventMusicCombined		= "Autoriser tous les choix de musique dans les sélection de donjon et de rencontre (changer cette option requiert de recharger l'interface)"
...
-- Panel: Color by Type
L.Panel_ColorByType	 		= "Couleurr par type"
...
L.BarStartColor				= "Couleur de début"
...
L.NoBarFade					= "Utiliser la couleur de début/fin comme couleur petite barre/grande barre au lieu du changement de couleur gradué"
...
L.DontPlayPTCountdown		= "Ne pas jouer aucun son de décompte de pull/pause/combat/perso"
